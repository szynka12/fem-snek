...
.. module:: connectivity
   :synopsis: Element connectivity list objects are defined in this module
...
class ConnectivityList:
    ...
    def fem_calculator(self) -> elements.Element:
        """
        Return static class providing necessary element calculations e.g. jacobian, shape functions

        :return: static element class
        """
